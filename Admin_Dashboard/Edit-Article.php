...
if (!$A_ID) {
    ...
    $sql2 = mysqli_query($con, "select * from languages_articles where id='$article_id'");
    ...
    if (isset($_POST['Submit'])) {
        ...
        $stmt = $con->prepare("UPDATE languages_articles SET language_id = ?, title = ?, link = ?, description = ? WHERE id = ? ");

        $stmt->bind_param("isssi", $language_id, $title, $link, $description, $article_id);
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <!-- Horizontal Form -->
                <form method="POST" action="./Edit-Article.php?article_id=<?php echo $article_id ?>&&language=<?php echo $language ?>&&language_id=<?php echo $language_id?>" enctype="multipart/form-data">
