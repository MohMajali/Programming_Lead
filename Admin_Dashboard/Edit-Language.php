...
if (!$A_ID) {
    ...
    if (isset($_POST['Submit'])) {
        ...
        if ($file) {
            ...
            $stmt = $con->prepare("UPDATE languages SET name = ?, image = ?, description = ?, started_date = ? WHERE id = ?");

            $stmt->bind_param("ssssi", $name, $file, $description, $started_date, $lang_id);
        ...
        document.location='./Languages.php';
            ...
            $stmt = $con->prepare("UPDATE languages SET name = ?, description = ?, started_date = ? WHERE id = ?");

            $stmt->bind_param("sssi", $name, $description, $started_date, $lang_id);
...
<html lang="en">
  <head>
    ...
    <title>Language - Programming Lead</title>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <!-- Horizontal Form -->
                <form method="POST" action="./Edit-Language.php?lang_id=<?php echo $lang_id ?>" enctype="multipart/form-data">
                ...
                <input type="hidden" name="lang_id" value="<?php echo $lang_id ?>">
                  ...
                  <div class="row mb-3">
                    ...
                    >
                    <div class="col-sm-10">
                      <input type="text" name="name" class="form-control" id="inputText" value="<?php echo $langName ?>"/>
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    >
                    <div class="col-sm-10">
                      <input type="date" class="form-control" name="started_date" value="<?php echo $started_date ?>" required/>
                    </div>
                  </div>
