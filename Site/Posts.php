...
if ($R_ID) {
    ...
    if (isset($_POST['Submit'])) {
        ...
        if ($file) {
            ...
            $stmt = $con->prepare("INSERT INTO posts (reader_id, title, description, image) VALUES (?, ?, ?, ?) ");

            $stmt->bind_param("isss", $reader_id, $title, $description, $file);
            ...
            alert ('A New Post Has Been Added Successfully !');
       </script>";
...
?></h5>
            ...
            <?php if ($R_ID) {?>
              ...
              <div class="card p-4">
                ...
                <input type="hidden" name="reader_id" value="<?php echo $R_ID ?>">
                ...
                <div class="tab-content pt-2">
                  ...
                  >
                    <div class="user-data-post">
                      <img src="${post?.reader_image}" class="" width="90px" height="90px" />
                      <h4 class="user-name">${post?.reader_name}</h4>
                    </div>
...
<div class="darker mt-4 text-justify" id="single-comment-${comment?.comment_reader_id}">
                                    <img src="${comment?.reader_image}" alt="" class="rounded-circle" width="40" height="40">
...
<input type="hidden" value="<?php echo $R_ID ?>" name="commenter_id">
